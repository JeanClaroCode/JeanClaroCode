...
<table border="none">
  <tr>
    <td>
      <h3>Front-End</h3>
      <img src="https://skillicons.dev/icons?i=js,ts,react,styledcomponents,tailwind,vite,redux" />
      <h3>Back-End</h3>
      <img src="https://skillicons.dev/icons?i=cs,dotnet,nodejs,postgres,mongodb,redis" />
       <h3>DevOps & Tools</h3>
      <img src="https://skillicons.dev/icons?i=docker,aws,git,githubactions,azure,figma" />
    </td>
    <td align="center">
